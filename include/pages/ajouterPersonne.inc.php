  ...
  && empty($_POST["sal_telprof"])))
  {
   ?>
     ...
     <form action ="#" method = "post" id = "AjouterPersonne">
       <div id="float">
          <label><span id="ranger">Nom :</span></label><input type="text" id="input" name="per_nom" required>
          <label id="milieu4"><span id="ranger">Prenom :</span></label> <input type="text" id="input" name="per_prenom" required></br>
          <label><span id="ranger">Téléphone :</span></label> <input type="tel" id="input" name="per_tel" required>
          <label id="milieu4"><span id="ranger">Mail :</span></label><input type="Mail" id="input" name="per_mail" required></br>
          <label><span id="ranger">Login :</span></label><input type="text" id="input" name="per_login" required>
